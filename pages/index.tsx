    ...
    <>
      ...
      <div className="flex flex-col items-center justify-center min-h-[70.6vh]">
        ...
        <p className="font-light w-4/6 text-sm mb-5 text-center p-4 sm:p-0">
          Our website, Dynato, is the leading platform for URL shortening
          services. Our goal is to make sharing links on the internet as easy
          and convenient as possible. Our user-friendly interface allows you to
          quickly and easily shorten any long or complicated URL into a shorter,
          more manageable link. With our platform, you can create short links
          for a variety of purposes, including sharing on social media,
          ...
          no further than Dynato. Sign up now and start shortening your links
          today.
        </p>
      </div>
